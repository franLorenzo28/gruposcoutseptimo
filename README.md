...
Producción recomendada: Vercel. También se incluyen scripts de despliegue en [scripts](scripts).

### Notas del archivo histórico

- La sección de locales históricos se encuentra en `/archivo/locales`.
- Las imágenes sugeridas para esa sección se organizan en [src/assets/locales-historicos](src/assets/locales-historicos).

### Licencia

Proyecto de uso interno/comunitario del Grupo Scout Séptimo.

---

## English

Official website of Grupo Scout Séptimo.

Main frontend built with React + TypeScript + Vite, styled with TailwindCSS and shadcn/ui, with optional local backend support for development.
...
Recommended production target: Vercel. Deployment scripts are also available in [scripts](scripts).

### Historical Archive Notes

- Historical locations are available at `/archivo/locales`.
- Suggested images for that section are organized in [src/assets/locales-historicos](src/assets/locales-historicos).

### License

Internal/community project for Grupo Scout Séptimo.
