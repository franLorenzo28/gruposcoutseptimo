-- Fix RLS policies v2 - permitir acceso a perfiles propios Y acceso admin
-- Corrección crítica: la versión anterior bloqueó a todos los usuarios
...
-- Los admins pueden ver todo en groups (mantener política admin)
